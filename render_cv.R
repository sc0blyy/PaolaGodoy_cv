...
cv_data <- create_CV_object(
  data_location = "https://docs.google.com/spreadsheets/d/1KbX1-YhKogV3vKTt0LmDSjEcInbQPDD79XDZ_QqVWHI/edit?gid=917338460#gid=917338460"
)
...
rmarkdown::render("cv_PaolaGodoy.rmd",
                  params = list(pdf_mode = FALSE),
                  output_file = "cv_PaolaGodoy.html")
